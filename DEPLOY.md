...
| `Wait longer` button not present | The button was removed in v0.3.37 — see the v0.3.37 changelog entry. Use "Back to sessions" or "Cancel and delete FRS" instead. | n/a |
